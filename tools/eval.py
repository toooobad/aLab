...
from aLab.register import EVALUATOR
from aLab.utils import (get_eval_cfgs, setup_logger, merge_cfgs, dump_cfgs, set_randomness)
...
def parse_args():
    ...
    parser.add_argument('--torch-model', type=str, default=None, help='Pre-trained model weights file. Default: None')
...
def main(default_cfgs: dict, cfgs: argparse.Namespace):
    ...
    # step7. test
    evaluator_cfg = dict(type=cfgs.task, cfgs=cfgs)
